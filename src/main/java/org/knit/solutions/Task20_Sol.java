...
@TaskDescription(taskNumber = 20, taskDescription = "Password Manager с Spring и шифрованием", href = "org/knit/solutions/taskExampleClasses/README.md")
public class Task20_Sol implements Solution {
    @Override
    public void execute() {
        System.out.println("Задача 20 запущена");
